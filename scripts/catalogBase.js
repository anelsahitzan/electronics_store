...
const targetPath = path.join(__dirname, '../src/data/mockData.ts');
...
const categoriesConfig = [
  { id: '1', name: 'Смартфоны', slug: 'smartphones', icon: '📱', isPopular: true },
  { id: '2', name: 'Ноутбуки', slug: 'laptops', icon: '💻', isPopular: true },
  { id: '3', name: 'Мониторы', slug: 'monitors', icon: '🖥', isPopular: true },
  { id: '4', name: 'Клавиатуры', slug: 'keyboards', icon: '⌨️', isPopular: false },
  { id: '5', name: 'Мыши', slug: 'mice', icon: '🖱', isPopular: false },
  { id: '6', name: 'Наушники', slug: 'headphones', icon: '🎧', isPopular: true },
  { id: '7', name: 'Смарт-часы', slug: 'smart-watches', icon: '⌚', isPopular: true },
  { id: '8', name: 'Игровые консоли', slug: 'gaming-consoles', icon: '🎮', isPopular: true },
  { id: '9', name: 'Планшеты', slug: 'tablets', icon: '📱', isPopular: false },
  { id: '10', name: 'Персональные ПК', slug: 'pc', icon: '🖥', isPopular: true },
  { id: '11', name: 'Телевизоры', slug: 'tv', icon: '📺', isPopular: true },
  { id: '12', name: 'SSD / HDD / флешки', slug: 'storage-devices', icon: '💾', isPopular: false },
  { id: '13', name: 'Комплектующие для ПК', slug: 'components', icon: '🧩', isPopular: false },
  { id: '14', name: 'Аксессуары', slug: 'accessories', icon: '🎒', isPopular: false },
];

module.exports = { images, categoriesConfig, targetPath };
